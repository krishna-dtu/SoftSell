...
>
  Easily Sell Your Software Licenses
    ...
    <section className="w-screen py-12 bg-white flex flex-col items-center dark:bg-gray-800">
      ...
      <div className="w-screen flex flex-col md:flex-row gap-8 px-8">
        <div className="flex-1 bg-gray-100 rounded-lg p-6 text-center shadow w-full">
          <p className="mb-2">"SoftSell made it so easy to sell our unused licenses. Fast and reliable!"</p>
          <span className="font-semibold">- John Doe, IT Manager, TechCorp</span>
        </div>
        <div className="flex-1 bg-gray-100 rounded-lg p-6 text-center shadow w-full">
          <p className="mb-2">"Great service and support. Highly recommended for any business."</p>
          <span className="font-semibold">- Jane Smith, Operations, FinServe</span>
        </div>
      </div>
    </section>
